 ...
 */
@Slf4j
public class ReactiveChaosChallengeTest extends BasePage {
    ...
    public ReactiveChaosChallengeTest navigateToPage() {
    ...
    public ReactiveChaosChallengeTest startChallenge() {
    ...
    public ReactiveChaosChallengeTest monitorDataStreams() {
    ...
    public ReactiveChaosChallengeTest performCalculations() {
        // Capture values
    ...
    public ReactiveChaosChallengeTest progressThroughSteps() {
    ...
    public ReactiveChaosChallengeTest validateSolution(String code) {
